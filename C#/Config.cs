...
public class Config
{
    ...
    public const string MODEL = @"D:\dev\code\CLion\tensorrt\workspace\model\engine\yolov8l.transd.engine";
    public const string IMAGE_SRC = @"D:\dev\code\CLion\tensorrt\workspace\images\car.jpg";
