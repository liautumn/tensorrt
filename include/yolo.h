...
namespace yolo {
    ...
    class Infer {
    public:
        virtual detect::BoxArray detect_forward(const Image &image, void *stream = nullptr) = 0;
        ...
        virtual pose::BoxArray pose_forward(const Image &image, void *stream = nullptr) = 0;

        virtual vector<pose::BoxArray> pose_forwards(const vector<Image> &images, void *stream = nullptr) = 0;
    };
