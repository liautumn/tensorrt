...
public:
    ...
    const string SEG_MODEL = R"(D:\autumn\Documents\GitHub\tensorrt\workspace\model\engine\yolo11s-seg.transd.engine)";
    ...
    const string OBB_IMG = R"(D:\autumn\Documents\GitHub\tensorrt\workspace\images\P0009.jpg)";
